...
namespace TestTOS
{
    public class Util
    {
        ...
        public static void CheckBucketMeta(ITosClient client, string bucket, string region, StorageClassType? storageClass, 
        ...
        public static void WaitUntilObjectExist(ITosClient client, string bucket, string key,int duration=DefaultDuration, int maxWaitTime=DefaultMaxWaitTime)
        {
        ...
        public static PutObjectOutput PutObjectFromStreamAndCheckResponse(ITosClient client, string bucket, string key, Stream content)
        {
            var putObjectInput = new PutObjectInput()
            {
                Bucket = bucket,
        ...
        public static PutObjectOutput PutObjectFromStringAndCheckResponse(ITosClient client, string bucket, string key, string data)
        {
            var putObjectInput = new PutObjectInput()
            {
                Bucket = bucket,
        ...
        public static GetObjectOutput GetObjectAndCheckResponse(ITosClient client, string bucket, string key, string data)
        {
